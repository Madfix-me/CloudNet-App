...
class InitAppStateAction extends ReduxAction<AppState> {
  ...
  Future<AppState?> reduce() async {
    ...
    final List<GroupConfiguration> groups =
        await ApiService().groupsApi.getGroups();
    final List<ServiceVersionType> versions =
        await ApiService().versionsApi.getVersions();
    final TemplateStorage templateStorage =
        await ApiService().templateStorageApi.getStorage();
